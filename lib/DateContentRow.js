...
var DateContentRow = function (_React$Component) {
  ...
  DateContentRow.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['rtl', 'events', 'range', 'className', 'selectable', 'renderForMeasure', 'startAccessor', 'endAccessor', 'renderHeader', 'minRows', 'maxRows', 'dateCellWrapper', 'eventComponent', 'eventWrapperComponent', 'onSelectStart', 'onSelectEnd', 'dayPropGetter']);
